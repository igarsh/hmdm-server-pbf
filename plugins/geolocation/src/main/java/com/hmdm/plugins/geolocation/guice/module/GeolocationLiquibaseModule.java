...
/**
 * <p>A module used for initializing and managing the state of the database tables related to <code>Geolocation</code>
 * plugin.</p>
 *
 * @author isv
 */
public class GeolocationLiquibaseModule extends AbstractLiquibaseModule {

    /**
     * <p>Constructs new <code>GeolocationLiquibaseModule</code> instance. This implementation does nothing.</p>
     */
    public GeolocationLiquibaseModule(ServletContext context) {
        super(context);
    }
    ...
    protected String getChangeLogResourcePath() {
        String path = this.getClass().getResource("/liquibase/geolocation.changelog.xml").getPath();
